...
Revision ID: 0c2edd885108
Revises: 
Create Date: 2025-07-11 11:40:55.951875+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("healthcare_provider_id", sa.UUID(), nullable=True),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.text("now()"),
    ...
    op.create_index(
        op.f("ix_audio_files_uploaded_at"), "audio_files", ["uploaded_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_notification_history_user_id"),
        "notification_history",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "raw_features", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_voice_analyses_analyzed_at"),
        "voice_analyses",
        ["analyzed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_voice_analyses_audio_file_id"),
        "voice_analyses",
        ["audio_file_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_notification_history_user_id"), table_name="notification_history"
    )
